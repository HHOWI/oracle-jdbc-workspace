...
--ALTER TABLE COMMENTS ADD CONSTRAINT COMMENTS_POST_CODE_FK FOREIGN KEY(POST_CODE) REFERENCES POST;                     -- 댓글 <- 게시글(게시글SEQ)
--ALTER TABLE COMMENTS ADD CONSTRAINT COMMENTS_MATCH_POST_CODE_FK FOREIGN KEY(MATCH_POST_CODE) REFERENCES MATCH_POST;   -- 댓글 <- 매칭글(매칭글SEQ)
...
--ALTER TABLE CATEGORY ADD CONSTRAINT CATEGORY_CATEGORY_TYPE_FK FOREIGN KEY(CATEGORY_TYPE) REFERENCES CATEGORYTYPE;     -- 카테고리 <- 카테고리 분류(카테고리 분류 SEQ)
