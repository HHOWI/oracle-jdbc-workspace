...
/*
    ...
    - 정확한 데이터 분석에 기반을 두지 않은 무분별한 인덱스는 오히려 성능을 떨어뜨림
*/
...
-- EMPLOYEE 테이블에 비공개 SYSNONYM 생성 (KH 계정에서)
CREATE SYNONYM EMP01 FOR EMPLOYEE;
