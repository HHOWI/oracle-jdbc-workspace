...
DROP TABLE MATCHING_LATE;   -- 매칭 후기
DROP TABLE MATCHING_INFO;   -- 매칭 정보
DROP TABLE CHAT;            -- 채팅 정보
...
-- 채팅
 CREATE TABLE CHAT (  
    ...
    CHAT_DATE DATE DEFAULT SYSDATE           -- 대화 시간
);
...
ALTER TABLE LIKE_INFO ADD CONSTRAINT LIKE_INFO_PK PRIMARY KEY(LIKE_UP_TARGET_SEQ);
...
ALTER TABLE MATCHING ADD CONSTRAINT MATCHING_CODE_PK PRIMARY KEY(MATCHING_CODE);        -- 매칭 코드
...
-- FK
ALTER TABLE USER_INFO ADD CONSTRAINT USER_NAME_FK FOREIGN KEY(USER_NAME) REFERENCES USER_PROFILE(USER_NAME);    -- 유저이름(유저정보, 유저프로필)
...
ALTER TABLE MATCHING ADD CONSTRAINT MATCHING_USER_ID_FK FOREIGN KEY(USER_ID) REFERENCES USER_INFO;      -- 매칭 (유저 아이디) 
