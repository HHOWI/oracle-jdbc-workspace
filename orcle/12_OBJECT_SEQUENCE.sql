...
*/
-- NEXTVAL을 한 번이라도 수행하지 않은 이상 CURRVAL를 가져올 수 없음!
-- CURRVAL은 마지막으로 성공적으로 수행된 NEXTVAL의 값을 저장해서 보여주는 임시값
...
INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO) VALUES(SEQ_EMPID.NEXTVAL, '김강우', '221227-3123456');

INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO) VALUES(SEQ_EMPID.NEXTVAL, '고아라', '230629-4987654');
